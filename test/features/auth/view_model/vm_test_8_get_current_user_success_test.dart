...
void main() {
  ...
  testWidgets('8. getCurrentUser success sets authenticated with user', (tester) async {
    when(() => mockGetCurrentUser.call()).thenAnswer((_) async => const Right(tAuthEntity));
    ...
    await runWithContext(tester, container, (ctx) =>
      container.read(authViewModelProvider.notifier).getCurrentUser(context: ctx),
    );
