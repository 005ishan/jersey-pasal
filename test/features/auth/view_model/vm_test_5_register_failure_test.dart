...
void main() {
  ...
  testWidgets('5. register failure sets status to error', (tester) async {
    when(() => mockRegister.call(any())).thenAnswer((_) async => Left(ApiFailure(message: 'Email already exists')));
    ...
    await runWithContext(tester, container, (ctx) =>
      container.read(authViewModelProvider.notifier).register(
